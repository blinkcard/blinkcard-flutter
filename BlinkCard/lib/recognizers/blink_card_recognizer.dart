...
class BlinkCardRecognizerResult extends RecognizerResult {
  ...
  BlinkCardRecognizerResult(Map<String, dynamic> nativeResult)
    ...
    this.documentLivenessCheck =
        nativeResult["documentLivenessCheck"] != null
            ? DocumentLivenessCheckResult(
              Map<String, dynamic>.from(nativeResult["documentLivenessCheck"]),
            )
            : null;

    this.expiryDate =
        nativeResult["expiryDate"] != null
            ? Date(Map<String, dynamic>.from(nativeResult["expiryDate"]))
            : null;
    ...
    this.firstSideFullDocumentImage =
        nativeResult["firstSideFullDocumentImage"];
    ...
    this.processingStatus =
        BlinkCardProcessingStatus.values[nativeResult["processingStatus"]];
    ...
    this.secondSideFullDocumentImage =
        nativeResult["secondSideFullDocumentImage"];
  }
}
...
class BlinkCardRecognizer extends Recognizer {
  ...
  BlinkCardAnonymizationSettings anonymizationSettings =
  ...
  BlinkCardDetectionLevel tiltDetectionLevel = BlinkCardDetectionLevel.Mid;
  ...
  factory BlinkCardRecognizer.fromJson(Map<String, dynamic> json) =>
      _$BlinkCardRecognizerFromJson(json);
